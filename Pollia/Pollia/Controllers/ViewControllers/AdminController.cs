...
namespace Pollia.Controllers.ViewControllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(IPlaceService placeService, IUserService userService, IArticleService articleService, IEventService eventService, IRoleService roleService)
        {
